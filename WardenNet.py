...
class WardenNet(nn.Module):
    ...
    def __init__(self, num_classes=1, input_channels=3, c_list=[8, 32, 32], bridge=True):
        super().__init__()
    ...
    def forward(self, x):
        ...
        t2 = out  # b, c1, H/4, W/4
        out = F.gelu(self.encoder6(out))  # b, c5, H/4, W/4
        t6 = out
        out2 = F.gelu(self.decoder4(out))  # b, c1, H/4, W/4
        out2 = torch.add(out2, t2)  # b, c1, H/4, W/4
        out1 = F.gelu(F.interpolate(self.dbn5(self.decoder5(out2)), scale_factor=(2, 2), mode='bilinear',  # bicubic  bilinear
